...
LangString inst_uninstall_question ${LANG_LITHUANIAN} "Dabartinė versija bus ištrinta. Vartotojo nustatymai ir torrentai išliks."
...
LangString inst_requires_64bit ${LANG_LITHUANIAN} "Šita diegimo programa veikia tiktais su 64-bit Windows."
;LangString inst_requires_win7 ${LANG_ENGLISH} "This qBittorrent version requires at least Windows 7."
LangString inst_requires_win7 ${LANG_LITHUANIAN} "Šita qBittorrent versija veikia nuo Windows 7."
;LangString inst_uninstall_link_description ${LANG_ENGLISH} "Uninstall qBittorrent"
LangString inst_uninstall_link_description ${LANG_LITHUANIAN} "Ištrinti qBittorrent"
